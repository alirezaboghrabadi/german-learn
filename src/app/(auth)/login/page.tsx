...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex">
      ...
      {/* Right - Graphic */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary via-primary-dark to-secondary items-center justify-center p-12">
        <div className="max-w-md text-center text-white">
          ...
          >
            ...
            <p className="text-white/80 text-lg">
              Your journey to mastering German starts here. Keep your streak alive and reach B2!
            </p>
